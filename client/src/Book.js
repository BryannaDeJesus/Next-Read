...
function Book() {
  ...
  const [apiKey, setApiKey] = useState(
    'AIzaSyDzE5gl0IrxmLYJuC_Dwf26Om2skuCG1us'
  );
    ...
    axios
      ...
      .then((data) => {
        ...
        setResult([
          ...
          description,
          previewLink,
          'Click the book image to be redirected to E-Book preview and purchase options.',
        ]);
    ...
    <>
      <article className='book'>
        ...
        <div className='button'>
          ...
          <button type='reset' onClick={buttonClear}>
            Clear
          </button>
        </div>
        <div className='title'>
        ...
        <div className='image'>
          <a target='_blank' href={result[4]}>
            <img src={result[2]} alt={result} />
          </a>
        </div>
